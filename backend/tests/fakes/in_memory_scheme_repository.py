...
class InMemorySchemeRepository:
    ...
    def search(self, query: str, regional_context: RegionalContext, top_k: int) -> list[SchemeChunk]:
        return [
            SchemeChunk("Farming scheme1","Good scheme", "No name", 
                        "No province", "https://no_name/farming/scheme", 0.95),
            SchemeChunk("Farming scheme2","Good scheme", "No name", 
                        "No province", "https://no_name/farming/scheme", 0.95),
            SchemeChunk("Farming scheme3","Good scheme", "No name", 
                        "No province", "https://no_name/farming/scheme", 0.95)
        ][:top_k]