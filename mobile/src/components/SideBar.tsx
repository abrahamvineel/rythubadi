...
export function Sidebar({ chats, activeChatId, onSelectChat, onNewChat, onDeleteChat, name, language, country, onLogout, onOpenProfile }: Props) {
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top + 16 }]}>
            ...
            <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
                ...
                {chats.map(chat => (
                    <View key={chat.id} style={chat.id === activeChatId ? styles.activeItemRow : styles.itemRow}>
                        ...
                        <TouchableOpacity onPress={() => onDeleteChat(chat.id)} hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}>
            ...
            {/* Profile section */}
            <TouchableOpacity
                style={[styles.profileSection, { paddingBottom: insets.bottom + 12 }]}
            ...
            >
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.profileSub}>{language} · {country}</Text>
...
const styles = StyleSheet.create({
    ...
    newChatButton: {
        ...
        padding: 12, borderWidth: 1, borderColor: "#43A047",
    },
    ...
    emptyChats: { color: "#81C784", fontSize: 12, paddingHorizontal: 16, paddingVertical: 8, opacity: 0.7 },
    ...
    profileSection: { flexDirection: "row", alignItems: "center", padding: 12, paddingBottom: 12, borderTopWidth: 1, borderTopColor: "#2E7D32", backgroundColor: "#163d17" },
